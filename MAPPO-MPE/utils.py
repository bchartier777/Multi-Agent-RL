...
def parse_args():
    ...
    parser.add_argument("--max_train_steps", type=int, default=int(3e6), help=" Maximum number of training steps. Default 3e6")
    parser.add_argument("--episode_limit", type=int, default=25, help="Maximum number of steps per episode")
    parser.add_argument("--evaluate_freq", type=float, default=5000, help="Evaluate the policy every 'evaluate_freq' steps")
    parser.add_argument("--evaluate_times", type=float, default=3, help="Evaluate times")
    parser.add_argument("--max_action", type=float, default=1, help="Max action value")
    ...
    parser.add_argument("--seed", type=int, default=0, help="Seed for Torch and Numpy")
    ...
    parser.add_argument("--random_steps", type=int, default=0, help="Number of random steps to start training")
    parser.add_argument("--add_noise_action", type=bool, default=False, help="Add noise to choose_action for exploration.")
